    ...
    <div class="dialog">
        ...
        <div class="content__left">
          ...
          <div class="row">
            ...
            <div class="input">
              <select
                name="feeGroup"
                v-model="fee.feeGroupID"
                class="m-select"
                placeholder="Chọn nhóm khoản thu..."
              >
                <option
                  v-for="feeGroup in listFeeGroup"
      ...
      <div class="dialog__footer">
        ...
        <div class="footer__item float--right">
          <button class="m-button" @click="editOnclick">Lưu</button>
        </div>
...
export default {
  ...
  methods: {
    ...
    editOnclick() {
      ...
      if (flag) {
        axios
          .put("https://localhost:44307/api/v1/Fee", this.fee)
          .then((res) => {
            alert(res.data);
          });
        this.close().catch((res) => {
          alert(res);
        });
      }
    },
